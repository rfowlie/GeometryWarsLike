...
public class ObjectPool<T> where T : MonoBehaviour
{
    ...
    public int GetDeactiveCount() { return deactive.Count; }
    private List<T> active;
    public int GetActiveCount() { return active.Count; }
    public List<T> GetActiveObjects() { return active; }
    ...
    //poolable component calls this to recycle
